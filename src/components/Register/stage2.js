                        ...
                        <div className='inputs_table'>
                            ...
                            <div className='image'>
                                <svg width="178" height="178" viewBox="0 0 178 178" fill="none" xmlns="http://www.w3.org/2000/svg">
                                    <g id="mage:check">
                                        <path id="Vector" d="M33.375 87.4796L64.6807 118.785C65.7819 119.901 67.0937 120.787 68.54 121.392C69.9864 121.997 71.5384 122.308 73.1061 122.308C74.6738 122.308 76.2258 121.997 77.6721 121.392C79.1185 120.787 80.4303 119.901 81.5314 118.785L144.625 55.6992" stroke="#373737" strokeWidth="1.5" strokeLinecap="round" strokeLinejoin="round" />
                                    </g>
                                </svg>
                            </div>
                            <p style={{ textAlign: 'center', fontSize: '1.2em' }}><NavLink to='/login' style={{ color: 'blue' }}>Увійдіть</NavLink>, щоб продовжити</p>
                        </div>
                    </div>
                </div>
            </div>
